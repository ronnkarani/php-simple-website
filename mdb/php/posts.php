...
if (isset($_POST['key'])) {
    try {
        ...
        if($_POST['key'] == "get_posts"){
            ...
            $sql = "INSERT INTO posts (title,titledetails, `description`, moredescription, author, category, `status`,created_at) VALUES ('$title', '$detailsTitle', '$detailsDescription', '$detailsMoreDescription', '$userid', '$category', '$status',current_timestamp)";
