...
if (isset($_POST['key'])) {
    try {
        ...
        if($_POST['key'] == "get_posts"){
            ...
            $sql = "SELECT DISTINCT category, categories.name FROM posts INNER JOIN categories ON categories.id = posts.category";
            ...
            if(count($categories)>0){
                ...
                $response = array('categories'=>$categoriesresult);
